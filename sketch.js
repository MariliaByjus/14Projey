 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon){
    case 1:red.addImage(redBalloon);//chamar o balãovermelho
    break;
    case 2:blue.addImage(blueBalloon);//chamar o balãoazul
    break;
    case 3:green.addImage(greenBalloon);//chamar o balãoverde
    break;
    case 4:pink.addImage(pinkBalloon);//chamar o balãorosa
    break;
   default: break;
  }
}
